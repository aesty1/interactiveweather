            ...
            <div className='blocks_wrapper grey_block_wrapper week_weather_wrapper'>
                ...
                <div className='week_weather_items__container'>
                    <div className='week_weather_item_wrapper'>
                        ...
                        <img className='week_weather_item_icon' src={this.state.day_icon.get("day0")}/>
                        <p className='very_small_black_text week_weather_item_text week_weather_item_description'>{this.state.day_description.get("day0")}</p>
                        <p className='very_small_black_text week_weather_item_text week_weather_item_temp'>{this.state.day_weather.get("day0")}</p>
                    </div>
                    <hr/>
                    <div className='week_weather_item_wrapper'>
                        ...
                        <img className='week_weather_item_icon' src={this.state.day_icon.get("day1")}/>
                        <p className='very_small_black_text week_weather_item_text week_weather_item_description'>{this.state.day_description.get("day1")}</p>
                        <p className='very_small_black_text week_weather_item_text week_weather_item_temp'>{this.state.day_weather.get("day1")}</p>
                    </div>
                    <hr/>
                    <div className='week_weather_item_wrapper'>
                        ...
                        <img className='week_weather_item_icon' src={this.state.day_icon.get("day2")}/>
                        <p className='very_small_black_text week_weather_item_text week_weather_item_description'>{this.state.day_description.get("day2")}</p>
                        <p className='very_small_black_text week_weather_item_text week_weather_item_temp'>{this.state.day_weather.get("day2")}</p>
                    </div>
                </div>
