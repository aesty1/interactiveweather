        ...
        return (
            <div className='blocks_wrapper grey_block_wrapper air_conditions_wrapper'>
                ...
                <div className='air_conditions__container'>
                    ...
                    <div className='air_conditions_item__container wind__container'>
                        <div className='air_conditions_item__wrapper'>
                            <img className='air_conditions_item__img wind_img' src={drop}/>
                            <p className='very_small_grey_text today_forecast_text'>Humidity</p>
                        </div>
                        <p className='big_black_text air_conditions__text'>{this.state.humidity}%</p> 
                    </div>
                    <div className='air_conditions_item__container wind__container'>
                        <div className='air_conditions_item__wrapper'>
                            <img className='air_conditions_item__img wind_img' src={sun}/>
                            <p className='very_small_grey_text today_forecast_text'>UV index</p>
                        </div>
                        <p className='big_black_text air_conditions__text'>{this.state.uv}</p> 
                    </div>
                </div>
